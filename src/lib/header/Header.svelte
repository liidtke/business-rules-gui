...
<header class="container">
	...
	<nav>
		...
		<ul>
			...
			<li class:active={$page.url.pathname === '/rules'}><a sveltekit:prefetch href="/rules">Regras</a></li>
			<li class:active={$page.url.pathname === '/about'}><a sveltekit:prefetch href="/about">Sobre</a></li>
		</ul>
		<svg viewBox="0 0 2 3" aria-hidden="true">
